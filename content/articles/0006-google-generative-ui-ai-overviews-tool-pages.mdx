...
<FigureStats
  title="Generative UIの評価と規模を示す数字"
  caption="Googleの論文とSearch Engine Journalの記事より"
  stats={[
    { value: "90%", label: "生成UIが上位検索結果に勝った割合", note: "主要プロンプトでの比較" },
    { value: "73.5%対19%", label: "情報探索系の質問での勝率", note: "生成UI対上位検索結果" },
    { value: "25億人超", label: "AI Overviewの月間利用者" },
  ]}
/>
