...
- [ ] 4. HOW TOのテーマ表 `content/howto-topics.csv`（人が採用を付ける）
- [ ] 5. `scripts/generate-howto.ts`（HOW TO専用プロンプト＋validate）と `npm run generate:howto`
- [ ] 6. 既存記事の `category` のクォート表記ゆれを統一
- [ ] 7. README / CLAUDE.md 更新
