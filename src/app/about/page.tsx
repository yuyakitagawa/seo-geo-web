...
const FAQ: FaqItem[] = [
  ...
  {
    question: "GEOやSEOについて相談できますか",
    answer:
      "お問い合わせの窓口からGEO・SEOについてのご相談を無料で受け付けています。当サイトは趣味で運営しているため、相談に費用はかかりません。自社サイトのAI検索対策、検索順位の伸び悩み、何から手を付けるべきかといった内容で構いません。対応は本業の時間外や土日が中心になるため、返信までに数日かかることや、すべてのご相談に返信できない場合があります。",
  },
  {
...
// 業務委託の導線は意図的に置いていない（PVが十分に伸びた段階で検討する方針）。GEO・SEOの相談は /contact で受け付ける。
  ...
  return (
    <>
      ...
      <p>
        ...
        GEO・SEOについてのご相談（自社サイトのAI検索対策、検索順位の伸び悩み、何から手を付けるべきかなど）も同じ窓口で受け付けています。
        趣味で運営しているサイトなので、ご相談は無料です。費用を請求することはありません。対応は本業の時間外や土日が中心になるため、返信までお時間をいただくことがあります。
      </p>
      {HAS_CONTACT_PAGE ? (
        <p>
