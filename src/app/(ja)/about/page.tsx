    ...
    <>
        ...
        <table className={TABLE.table}>
          <tbody>
            {[
              ...
              [
                "更新の頻度",
                `毎朝7時（日本時間）に下書きを生成し、一次情報との照合後に公開。${facts.latest ? `直近の公開は${jp(facts.latest)}` : "確認を終えた記事が無い日は公開なし"}`,
              ],
            ].map(([label, value], i) => (
      ...
      <ol>
        ...
        <li>
          ...
          基準を満たさない原稿は公開せず破棄します。検査を通った原稿も下書きのまま保存します。
        </li>
        <li>運営者が本文と一次情報を照合し、必要な加筆・訂正をした記事だけを公開します。公開後に誤りや古くなった記述が見つかった場合は、本文を訂正して更新日を表示するか、記事を取り下げます。</li>
      </ol>
      <p>
