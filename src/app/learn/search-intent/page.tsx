  ...
  return (
    <LessonShell lesson={lesson} toc={TOC}>
      ...
      >
        ...
        />
        <p>
          次のレッスン{lessonNo("long-tail")}では、ここで決めた意図を細かいクエリの面に広げ、何ページ作るかを決めます。
          その先のレベル2では、技術的な土台（レッスン{lessonNo("technical")}）、本文の書き方（レッスン{lessonNo("writing")}）、
          サイト構造（レッスン{lessonNo("structure")}）、ドメインの置き場所（レッスン{lessonNo("domain")}）、AIクローラーへの対応（レッスン{lessonNo("geo-implementation")}）の順に実装していきます。
        </p>
      </GuideSection>
    </LessonShell>
  );
