      ...
      <div className="prose prose-neutral mx-auto max-w-3xl px-5 py-14 dark:prose-invert prose-headings:scroll-mt-24 sm:py-20">
        ...
        <section id="how" className="scroll-mt-24">
          ...
          <p>
            ...
            すべての実例は<Link href={lessonPath("case-studies")}>レッスン10</Link>にまとめてあります。
          </p>
        </section>
        ...
        <section id="levels" className="scroll-mt-24">
          ...
          <FigureStack
            title="レベル1から順に積む"
            layers={[
              { label: "Level 3 運用", tone: "geo", note: "レッスン09-11", desc: "数値で効果を確認し、実例から共通パターンを取り出し、アップデートとペナルティに備える。" },
              { label: "Level 2 実装", tone: "seo", note: "レッスン04-08", desc: "技術的な土台、本文の書き方、サイト構造、ドメインの置き場所、AIクローラーへの対応を順に仕上げる。" },
        ...
        <section id="who" className="scroll-mt-24">
          ...
          <GuideTable
            ...
            rows={[
              ...
              ["サブドメインを増やすか、リニューアルでURLを変えるか迷っている", "レッスン07", "ドメインを分けた分だけ、設定と計測の単位が増えるため"],
              ["SEOは回っているがAI検索に出てこない", "レッスン08", "AI各社のクローラー設定と、抜き出されやすい書き方が別作業のため"],
              ["施策を続けているが効果が判断できない", "レッスン09", "見るべき指標と見る順番が決まっていないため"],
              ["アップデートで流入が落ちた", "レッスン11", "原因の切り分け手順を先に決める必要があるため"],
            ]}
          />
        </section>
