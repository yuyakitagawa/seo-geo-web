...
export const CRAWLERS: Crawler[] = [
  ...
  },
  {
    ...
    vendor: "OpenAI",
    purpose: "ai-search",
    role: "ユーザーの操作を起点に、ChatGPTがその場でページへアクセス（取得）することがある。自動巡回はしない。",
    ifBlocked: "ChatGPTがページを取得できず、回答にそのページの内容が使われなくなる。",
  ...
  },
  {
    ...
    vendor: "Perplexity",
    purpose: "ai-search",
    role: "ユーザーの質問に答えるために、Perplexityがその場でページへアクセス（取得）し、回答にリンクを添える。巡回や学習には使われない。",
  ...
  },
  {
    ...
    vendor: "Anthropic",
    purpose: "ai-search",
    role: "ユーザーの操作を起点に、Claudeがその場でページへアクセス（取得）する。自動巡回はしない。",
    ifBlocked: "Claudeがページを取得できず、回答にそのページの内容が使われなくなる。",
    source: ANTHROPIC,
    verified: V,
  },
  {
