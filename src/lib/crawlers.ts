...
export const CRAWLERS: Crawler[] = [
  ...
  },
  {
    ...
    vendor: "OpenAI",
    purpose: "ai-search",
    role: "ユーザーの操作を起点に、ChatGPTがその場でページを取りに来るアクセス。自動巡回はしない。",
  ...
  },
  {
    ...
    vendor: "Perplexity",
    purpose: "ai-search",
    role: "ユーザーの質問に答えるために、Perplexityがその場でページを訪問し、回答にリンクを添えるアクセス。巡回や学習には使われない。",
  ...
  },
  {
    ...
    vendor: "Anthropic",
    purpose: "ai-search",
    role: "ユーザーの操作を起点に、Claudeがその場でページを取りに来るアクセス。自動巡回はしない。",
