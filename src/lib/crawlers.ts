...
export const CRAWLERS: Crawler[] = [
  ...
  },
  {
    ...
    vendor: "OpenAI",
    purpose: "ai-search",
    role: "ユーザーがChatGPTに質問したとき、その質問に応じてページへアクセス（取得）することがある。自動巡回はしない。",
  ...
  },
  {
    ...
    vendor: "Perplexity",
    purpose: "ai-search",
    role: "ユーザーの質問に答えるためにページへアクセス（取得）し、回答にリンクを添えるアクセス。巡回や学習には使われない。",
  ...
  },
  {
    ...
    vendor: "Anthropic",
    purpose: "ai-search",
    role: "ユーザーがClaudeに質問したときにページへアクセス（取得）する。",
