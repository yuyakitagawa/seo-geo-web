...
export const ABOUT_FAQ: FaqItem[] = [
  ...
  },
  {
    ...
    answer:
      "記事の下書きは、公式発表や業界メディアの一次情報をAIに読ませて作成します。出典URL・数値・固有名詞・構成を自動検査した後も下書きのまま保存し、運営者が本文と一次情報を照合して必要な加筆・訂正をした記事だけを公開します。公開後に誤りの指摘を受けた記事は、一次情報と突き合わせて確認し、訂正または削除します。",
  },
  {
    question: "記事は毎日更新されますか",
    answer:
      "毎朝7時（日本時間）に下書き生成のバッチが動きます。公開は運営者が一次情報との照合を終えた後に行うため、確認を終えた記事が無い日は更新されません。",
  },
  {
