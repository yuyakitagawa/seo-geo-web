...
export const LESSONS: Lesson[] = [
  ...
  },
  {
    ...
    order: 10,
    level: 2,
    title: "AIクローラーとrobots.txt",
    h1: "AIクローラー14種の一覧と、robots.txtでの書き分け",
    metaTitle: "AIクローラー一覧とrobots.txtの書き方｜GPTBot・OAI-SearchBot・Google-Extendedの違い",
    description:
      "AI検索・AI学習のクローラー14種を、User-agent名・提供元・拒否したときに起きることの一覧にしました。学習だけ拒否してAI検索には出る書き方、コピーして使えるrobots.txtのひな形3種、公式IP帯でなりすましを見分ける手順まで、各社の公式ドキュメントを出典に載せています。",
    goal: "AI各社のクローラーをUser-agent単位で見分け、robots.txtに意図どおり書き分けられるようになる。",
    objectives: [
      "AI検索用・AI学習用・検索エンジン用のクローラー14種の一覧（User-agent名・提供元・拒否したときに起きること）",
      "学習には使わせずAI検索には出す書き方と、コピーして使えるrobots.txtのひな形3種",
      "GPTBotを名乗る偽装アクセスを、提供元公式のIP帯で見分ける手順",
